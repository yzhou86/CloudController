...
public interface Image extends BasicResource, Buildable<ImageBuilder> {
	...
	/**
	 * Timestamp when an image's metadata was last updated, not its image data,
	 * as all image data is immutable once stored in Glance
	 * 
	...
	/**
	 * A mapping of free-form key/value pairs that have been saved with the
	 * image metadata
	 * 
	...
	/**
	 * This will always be null on any list or get request. It is intented as an
	 * option for creating, updating or reserving images
	 * 
