...
/**
 * A permission scheme a user is assigned when performing specific operations. A
 * role includes a set of rights and previleges. Any user who is assigned the
 * role inherits these traits.
 * 
 * @author Jeremy Unruh
 */
