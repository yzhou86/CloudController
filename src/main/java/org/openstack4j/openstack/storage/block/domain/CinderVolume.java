...
public class CinderVolume implements Volume {
	...
	public String toString() {
		return Objects.toStringHelper(this).omitNullValues().add("id", id)
				...
				.add("created", created).add("volumeType", volumeType)
				.add("imageRef", imageRef).add("sourceVolid", sourceVolid)
				.add("snapshotId", snapshotId).add("metadata", metadata)
				.add("bootable", bootable).toString();
	}
