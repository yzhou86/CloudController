...
public class CinderVolumeSnapshot implements VolumeSnapshot {
	...
	public String toString() {
		return Objects.toStringHelper(this).omitNullValues().add("id", id)
				...
				.add("volumeId", volumeId).add("status", status)
				.add("created", created).add("force", force).add("size", size)
				.toString();
	}

	public static class VolumeSnapshots extends
			ListResult<CinderVolumeSnapshot> {
	...
	public static class ConcreteVolumeSnapshotBuilder implements
