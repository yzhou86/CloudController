...
public class KeystoneServiceEndpoint implements ServiceEndpoint {
	...
	@Override
	public int hashCode() {
		return Objects.hashCode(id, region, publicURL, internalURL, adminURL,
				serviceId);
	}
	...
	public String toString() {
		return Objects.toStringHelper(this).omitNullValues().add("id", id)
				...
				.add("serviceId", serviceId).toString();
	}

	public static class ServiceEndpoints extends
			ListResult<KeystoneServiceEndpoint> {
	...
	public static class ServiceConcreteEndpointBuilder implements
