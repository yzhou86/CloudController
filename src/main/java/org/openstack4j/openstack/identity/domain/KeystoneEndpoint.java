...
/**
 * Endpoint Model is used to describe a network address which is described by
 * URL's and other service information depending on the context it was retrieved
 * in.
 * 
 * @author Jeremy Unruh
 * 
 * @see <a href=
 *      "http://docs.openstack.org/api/openstack-identity-service/2.0/content/GET_listEndpointsForToken_v2.0_tokens__tokenId__endpoints_Token_Operations.html#GET_listEndpointsForToken_v2.0_tokens__tokenId__endpoints_Token_Operations-Response"
 */
...
public class KeystoneEndpoint implements Endpoint {
	...
	/**
	 * @return the id for this endpoint (null if a new endpoint is being
	 *         created)
	 */
	public String getId() {
		return id;
	...
	/**
	 * @return the name of this endpoint, or null when the endpoint is part of
	 *         the Access ServiceCatalog
	 */
	...
	/**
	 * @return the admin URL for this endpoint, or null when the endpoint is
	 *         part of the Access ServiceCatalog
	 */
	...
	/**
	 * @return the version information when endpoint is listed as part of Access
	 *         Service Catalog, otherwise null
	 */
	...
	/**
	 * @return the version list when endpoint is listed as part of Access
	 *         Service Catalog, otherwise null
	 */
	...
	@Override
	public int hashCode() {
		return Objects.hashCode(id, versionId, region, publicURL, internalURL,
				adminURL, versionInfo, versionList, tenantId, type);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equal(this.id, that.id)
				&& Objects.equal(this.versionId, that.versionId)
	...
	public String toString() {
		return Objects.toStringHelper(this).omitNullValues().add("id", id)
				.add("name", name).add("type", type).add("region", region)
				.add("publicURL", publicURL).add("internalURL", internalURL)
				.add("adminURL", adminURL).add("versionId", versionId)
				.add("versionInfo", versionInfo)
				.add("versionList", versionList).toString();
	}
