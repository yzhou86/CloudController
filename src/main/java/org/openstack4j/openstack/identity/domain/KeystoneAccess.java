...
public class KeystoneAccess implements Access {
	...
	public String toString() {
		return Objects.toStringHelper(this).omitNullValues()
				.add("token", token).add("serviceCatalog", serviceCatalog)
	...
	public static final class AccessUser implements UserDetails {
		...
		public String toString() {
			return Objects.toStringHelper(this).omitNullValues().add("id", id)
					.add("name", name).add("username", username)
					.add("enabled", enabled).add("roles", roles)
					.add("rolesLinks", rolesLinks).toString();
		}
		...
		public static final class AccessRole extends KeystoneRole {
			...
			public String toString() {
				return Objects.toStringHelper(this).omitNullValues()
						...
						.add("tenantId", getTenantId()).toString();
			}
		}
	}
