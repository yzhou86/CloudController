...
/**
 * Base Networking Operations Implementation is responsible for insuring the
 * proper endpoint is used for all extending operation APIs
 * 
 * @author Jeremy Unruh
 */
public class BaseNetworkingServices extends BaseOpenStackService {
	...
	/**
	 * Due to a glitch in the Access returned from some installations the Nova
	 * endpoint will not contain the version. This allows us to inject it into
	 * the URL if it isn't defined
	 */
