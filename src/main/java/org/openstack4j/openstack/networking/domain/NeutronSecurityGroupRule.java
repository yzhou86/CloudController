...
public class NeutronSecurityGroupRule implements SecurityGroupRule {
	...
	public String toString() {
		return Objects.toStringHelper(this).omitNullValues().add("id", id)
				...
				.add("direction", direction).add("ethertype", etherType)
				.add("portRangeMin", portRangeMin)
				.add("portRangeMax", portRangeMax).add("protocol", protocol)
				.add("remoteGroup", remoteGroupId)
				.add("remoteIpPrefix", remoteIpPrefix).addValue("\n")
				.toString();
	}
	 ...
	 * @author Nathan Anderson
	 */
	public static class SecurityGroupRules extends
			ListResult<NeutronSecurityGroupRule> {
	 ...
	 * @author Nathan Anderson
	 */
	public static class SecurityGroupRuleConcreteBuilder implements
