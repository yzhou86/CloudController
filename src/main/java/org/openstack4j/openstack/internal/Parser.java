...
/**
 * Provides common parser routines when dealing with Headers or other non-json
 * payloads
 * 
 * @author Jeremy Unruh
 */
public abstract class Parser {
	...
	/**
	 * Takes a String Date and decodes it into a date. Returns null if the date
	 * is null
	 * 
	 * @param date
