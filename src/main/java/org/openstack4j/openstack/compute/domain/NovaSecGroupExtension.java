...
public class NovaSecGroupExtension implements SecGroupExtension {
	...
	/**
	 * Security Groups only need two fields populated when Created so instead of
	 * a builder the API can leverage this call to create a new Security Group
	 * 
	 * @param name
	...
	public String toString() {
		return Objects.toStringHelper(this).omitNullValues().add("id", id)
				...
				.add("tenantId", tenantId).add("rules", rules)
				.add("links", links).toString();
	}

	public static class SecurityGroups extends
			ListResult<NovaSecGroupExtension> {
	...
	public static class SecurityGroupRule implements SecGroupExtension.Rule {
		...
		public String toString() {
			return Objects.toStringHelper("Rule").omitNullValues()
					...
					.add("fromPort", fromPort).add("toPort", toPort)
					.add("ipProtocol", ipProtocol).add("range", ipRange)
		...
		public static class RuleConcreteBuilder implements
		...
		public static class RuleGroup implements Group {
			...
			public String toString() {
				return Objects.toStringHelper(this).omitNullValues()
						.add("name", name).add("tenantId", tenantId).toString();
			}
		...
		public static class RuleIpRange implements IpRange {
			...
			@Override
			public String toString() {
				return Objects.toStringHelper(this).add("cidr", cidr)
						.toString();
			}
