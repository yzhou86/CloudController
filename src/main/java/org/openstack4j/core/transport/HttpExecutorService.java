...
public interface HttpExecutorService {
	...
	/**
	 * Executes the given request and returns the {@code HttpResponse} result
	 * from the server
	 *
	 * @param <R>
	 *            the underlying return entity type
	 * @param request
	 ...
	 *            set this to true if the endpoint is using a self-signed
	 *            certificate. False to use trusted only client
	 * @return HttpResponse from the server
	 */
