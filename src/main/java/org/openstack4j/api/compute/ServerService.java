...
public interface ServerService {
	 ...
	 *
	 * @param detail
	 *            if true all attributes will be populated, false (brief) will
	 *            be ID, Name and Links
	 * @return list of all servers
	 */
	...
	/**
	 * Executes the specified Action such as RESUME, PAUSE, START, STOP ... see
	 * (@link {@link Action} for all possible actions
	 *
	 * @param serverId
	 *            the server identifier to execute the action against
	 * @param action
	 *            the action the specified action
	...
	/**
	 * Resize a server's resources. Until a resize event is confirmed
	 * {@link #confirmResize(String)}, the old server will be kept around and
	 * you'll be able to roll back to the old flavor quick with
	 * {@link #revertResize(String)}. All resizes will be automatically
	 * confirmed after 24 hours.
	 * 
	 * @param serverId
	 *            the server identifier
	 * @param flavorId
	 *            the new flavor id to resize to
	 * @return the action response
	 */
	...
	/**
	 * Associates the specified Server Group by name to the Server by it's
	 * identifier
	 * 
	 * @param serverId
	 *            the server identifier
	...
	/**
	 * Removes the specified Server Group by name from the Server by it's
	 * identifier
	 * 
	 * @param serverId
	 *            the server identifier
	...
	/**
	 * Gets usage information about the server. Usage includes CPU, Memory, IO.
	 * Information is dependent on the hypervisor used by the OpenStack
	 * installation and whether that hypervisor supports diagnostics
	 *
	 * @param serverId
	 *            the server id
	...
	/**
	 * Obtains the VNC Console connection information for the given server and
	 * VNC Console Type
	 * 
	 * @param serverId
	 *            the server identifier
