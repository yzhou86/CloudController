...
public interface RouterService extends RestService {
	 ...
	 * tenant who submits the request, unless the request is submitted by an
	 ...
	 * 
	 * @param routerId
	 *            the router identifier to delete
	 */
	 ...
	 * @param adminStateUp
	 *            the initial administrative state
	...
	/**
	 * Updates a Router. Based on the OpenStack API documentation only [ name,
	 * admin_state_up and external_gateway_info ] will be updated.
	 * 
	 * NOTE: The router identifier must be set in the {@code router}. See
	 * {@link Router#setId(String)}
	 * 
	 * @param router
	 ...
	 *            the router identifier
	 * @param adminStateUp
	 *            true to enable the administrative state up
	 * @return the updated router
	 */
	 ...
	 *            the router identifier
	 * @param type
	 *            the type of {@code portOrSubnetId} identifier
	 * @param portOrSubnetId
	 *            the port or subnet identifier
	 * @return the newly created router interface
	 */
	RouterInterface attachInterface(String routerId, AttachInterfaceType type,
			String portOrSubnetId);

	/**
	 * Removes an internal router interface, which detaches a subnet from the
	 * router. Either a subnet or port is allowed to be set and or both. At
	 * least one subnet or port identifier must be set or else a validation
	 ...
	 */
	RouterInterface detachInterface(String routerId, String subnetId,
			String portId);
}
